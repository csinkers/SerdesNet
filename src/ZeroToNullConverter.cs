...
namespace SerdesNet
{
    public sealed class ZeroToNullConverter :
    ...
    {
        public static readonly ZeroToNullConverter Instance = new ZeroToNullConverter();
        ZeroToNullConverter() { }
        ...
        public string ToSymbolic(  byte? x) => x?.ToString();
        public string ToSymbolic( sbyte? x) => x?.ToString();
        public string ToSymbolic(ushort? x) => x?.ToString();
        public string ToSymbolic( short? x) => x?.ToString();
        public string ToSymbolic(  uint? x) => x?.ToString();
        public string ToSymbolic(   int? x) => x?.ToString();
        public string ToSymbolic( ulong? x) => x?.ToString();
        public string ToSymbolic(  long? x) => x?.ToString();
    ...
    public sealed class ZeroToNullConverter<T> :
        IConverter<byte, T?>,
        IConverter<sbyte, T?>,
        IConverter<ushort, T?>,
        IConverter<short, T?>,
